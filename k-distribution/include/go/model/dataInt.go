...
var IntZero = addConstantObject(&BigInt{Value: big.NewInt(0)})

// IntOne is a reference to the constant integer 1
var IntOne = addConstantObject(&BigInt{Value: big.NewInt(1)})

// IntMinusOne is a reference to the constant integer -1
var IntMinusOne = addConstantObject(&BigInt{Value: big.NewInt(-1)})
