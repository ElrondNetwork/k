...
/**
 * Temporarily copied DefinitionToOcaml here to play around and compare.
 */
public class DefinitionToOcamlTempCopy implements Serializable {
    ...
    public DefinitionToOcamlTempCopy(
    ...
    /*public void initialize(DefinitionToOcamlTempCopy serialized, CompiledDefinition def) {
    ...
    public String definition() {
        ...
        List<List<KLabel>> functionOrder = sortFunctions(klabelRuleMap);
        ...
        for (List<KLabel> component : functionOrder) {
            ...
            if (component.size() == 1) {
                ...
                for (Rule r : klabelRuleMap.get(component.get(0))) {
        ...
        if (matchThreadSet == null) {
            ...
            sb.append("rewrite_thread_set (c: k) (config: k) (guard: int) (new_threads: k) : k = match c with \n");
            {
                ...
                String result = convertVars(vars);
                String suffix = "";
    ...
    private String convertVars(VarInfo vars) {
        StringBuilder sb = new StringBuilder();
